  ...
  const testimonials = [
    {
      name: "John Doe",
      role: "Rice Farmer",
      feedback: "iFarmr has revolutionized the way I manage my farm!",
      img: testimonialJohn,
    },
    {
      name: "Jane Smith",
      role: "Poultry Farmer",
      feedback: "The community feature has been a game-changer for me.",
      img: testimonialJane,
    },
    {
      name: "Ahmed Musa",
      role: "Maize Farmer",
      feedback: "Real-time weather updates saved my crops last season.",
      img: testimonialAhmed,
    },
  ];
    ...
    <div>
      ...
      <section className="hero" style={{ backgroundImage: `url(${corn})` }}>
        <div className="hero-container">
          ...
          <h2>
            Optimize your farming operations and connect with a community of
            experts.
          </h2>
      ...
      <section className="why-choose">
        <div className="container-choose">
          ...
          <p>
            Explore the Powerful Tools iFarmr Offers to Streamline <br /> Your
            Farming Operations.
          </p>
        </div>
        <div className="features">
          ...
          <div className="feature">
            ...
            <h3>Monitor your livestocks health and growth</h3>
          </div>
          <div className="feature">
      ...
      >
        <div className="containerrr">
          <div className="cta-content">
            ...
            <p>
              Join thousands of farmers optimizing their operations with iFarmr.
            </p>
            <div className="cta-buttons">
              <a href="#" className="btn-primary">
                Sign Up for Free
      ...
      <section className="how-it-works">
        <div className="containerss">
          <div className="contents">
            <h2>How It Works?</h2>
            <p>
              From Sign-Up to Successful Farming—Follow <br /> These Simple
              Steps to Unlock the Full Potential of <br /> iFarmr and Transform
      ...
      <section className="testimonials">
        <div className="text-container">
          <h2>Testimonials</h2>
          <p>
            Hear From Farmers Who Have Transformed Their Operations-Discover{" "}
            <br /> How iFarmr is Making a Real Difference in the Lives of
            Agricultural <br /> Professionals Everywhere.
          </p>
        </div>
      ...
      <section className="insights">
        <div className="insight-text">
          <h2>
            Insights & Stories from <br /> the Farming World
          </h2>
          <p>
